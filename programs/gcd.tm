...
;; the state set 
#Q = {initial,halt_accept,READ_do,READ_cl,READ_end,RET_do,RET_cl,RET_end,SW_LT_do,SW_LT_cl,SW_LT_cl2,SW_LT_end,EUCLID_do,EUCLID_end,SUB_do,SUB_end,SUB_cl,EQ_do,EQ_cl,EQ_end}

;; the input symbol set 
#S = {0,1}

;; the tape symbol set
#G = {0,1,_,a,b,c,d,e,f,g,h,i,j,t}
